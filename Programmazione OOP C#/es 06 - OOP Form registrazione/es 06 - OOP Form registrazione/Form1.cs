...
namespace es_06___OOP_Form_registrazione
{
    public partial class Form1 : Form
    {
        ...
        private void btnRegistra_Click(object sender, EventArgs e)
        {
            ...
            Regex regUsername = new Regex(@"^[A-Za-z,\d,\-,_,.]+$");
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    Utente utente = Utente.creaUtente(txtCognome.Text, txtNome.Text, txtIndirizzo.Text, txtCitta.Text, txtCAP.Text, txtMail.Text,txtCodiceFiscale.Text, txtUsername.Text, txtPassword.Text);
